...
namespace FunctionAppAcoes
{
    public static class AcoesServiceBusTopicTrigger 
    {
        ...
        public static void Run([ServiceBusTrigger("topic-acoes", "groffesubscription", Connection = "AzureServiceBusConnection")]string mySbMsg, ILogger log)
        {
            log.LogInformation($"AcoesServiceBusTopicTrigger - Dados: {mySbMsg}");
            
            var acao = JsonSerializer.Deserialize<Acao>(mySbMsg,
